...
class RelativeFlowTime(DateTimeSinceEpoch):
    ...
    TODO: Fix Time ingestion. 
        ...
        Same packets generate different times when rerun
    '''
    def run(self,inputObject):
        ...
        # print "deltatime =  %s"%datetime.timedelta(self.getDateTime(inputObject.end_time), self.getDateTime(inputObject.start_time) )
